...
export default {
  ...
  home: {
    heroTitle: "Organize Your Perfect Event",
    heroSubtitle: "Plan, coordinate and enjoy your special day with our professional tools.",
    becomeClient: "I am a client",
    ...
    clientPresentationTitle: "For Clients",
    clientPresentationDescription: "Discover all the features designed to help you organize your perfect event.",
    watchClientPresentation: "Client features",
    partnerPresentationTitle: "For Vendors",
    partnerPresentationDescription: "Learn how our platform helps you showcase your services and grow your business.",
    watchPartnerPresentation: "Vendor features",
  ...
  contact: {
    ...
    messageResponse: "We will get back to you as soon as possible.",
    form: {
      name: "Your name",
    ...
    info: {
      ...
      phone: "Phone",
      address: "Address",
      addressLine1: "123 Champs-Élysées Avenue",
      addressLine2: "75008 Paris, France",
      hours: {
        title: "Opening hours",
        weekdays: "Monday - Friday",
        weekdayHours: "9am - 6pm",
        saturday: "Saturday",
        saturdayHours: "10am - 3pm",
        sunday: "Sunday",
        sundayHours: "Closed"
      }
    },
