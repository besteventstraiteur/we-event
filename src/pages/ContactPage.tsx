    ...
    <div className="min-h-screen bg-vip-black flex flex-col">
      ...
      <main className="flex-1 container py-12">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-vip-gray-400 text-center mb-12">
            Nous sommes à votre disposition pour répondre à toutes vos questions
          </p>
          
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              <form onSubmit={handleSubmit} className="space-y-6 bg-vip-gray-900 p-6 rounded-lg border border-vip-gray-800">
                <div>
                  <label htmlFor="name" className="block text-sm font-medium text-vip-gray-300 mb-1">
                    Votre nom
                  </label>
                  <Input 
                    id="name"
                ...
                <div>
                  <label htmlFor="email" className="block text-sm font-medium text-vip-gray-300 mb-1">
                    Votre email
                  </label>
                  <Input 
                    id="email"
                ...
                <div>
                  <label htmlFor="subject" className="block text-sm font-medium text-vip-gray-300 mb-1">
                    Sujet
                  </label>
                  <Select
                ...
                <div>
                  <label htmlFor="message" className="block text-sm font-medium text-vip-gray-300 mb-1">
                    Votre message
                  </label>
                  <Textarea
                    id="message"
            ...
            <div>
              <div className="bg-vip-gray-900 p-6 rounded-lg border border-vip-gray-800 space-y-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      <p className="font-medium text-vip-white">Email</p>
                      <a href="mailto:contact@best-events-vip.com" className="text-vip-gray-400 hover:text-vip-gold">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <p className="font-medium text-vip-white">Téléphone</p>
                      <a href="tel:+33123456789" className="text-vip-gray-400 hover:text-vip-gold">
                        +33 1 23 45 67 89
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <p className="font-medium text-vip-white">Adresse</p>
                ...
                <div className="pt-6 border-t border-vip-gray-800">
                  <h3 className="text-vip-white font-medium mb-3">Horaires d'ouverture</h3>
                  <div className="space-y-2 text-vip-gray-400">
              ...
              <div className="mt-6 bg-vip-gray-900 p-6 rounded-lg border border-vip-gray-800">
                <h2 className="text-xl font-semibold text-vip-gold mb-4">Suivez-nous</h2>
                <div className="flex gap-4">
                  <a href="#" className="p-2 bg-vip-gray-800 rounded-full hover:bg-vip-gold/20">
